...
public class ImgManipUtil {
    ...
    public static final int NOTSQUARE = 300;
     ...
     *
     * @param mat n-dimensional dense numerical single-channel or multi-channel array
    ...
    public static void drawLine(double[] line, Mat m) {
        ...
        Imgproc.line(m, start, end, new Scalar(255, 255, 255), 3);
    }
